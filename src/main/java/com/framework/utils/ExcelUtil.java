...
public class ExcelUtil {
    ...
    public static void exportExcel(String title, Map<String, String> headMap, JSONArray jsonArray, String datePattern, int colWidth, OutputStream out) {
        ...
        workbook.getDocumentSummaryInformation().setCompany("亳州市教育局");
        SummaryInformation si = workbook.getSummaryInformation();
        si.setAuthor("系统管理员");  //填加xls文件作者信息
        si.setApplicationName("来文"); //填加xls文件创建程序信息
        si.setLastAuthor("系统管理员"); //填加xls文件最后保存者信息
        si.setComments("系统管理员"); //填加xls文件作者信息
        ...
        for (Iterator<String> iter = headMap.keySet().iterator(); iter
            ...
            headers[ii] = getByFileName(fieldName, headMap);
    ...
    private static String getByFileName(String key, Map<String, String> headMap) {
        boolean contains = headMap.containsKey(key);    //判断是否包含指定的键值
        if (contains) {         //如果条件为真
